...
setwd(folder)
neighbor<-read.csv("new_nn_elv_20140320.csv")
...
par(mar=c(3,4,1.5,2),oma=c(0,0,0,0),las=1,tcl=0.5, xaxs="i", yaxs="i", mgp=c(1.6,0.2,0),family="Helvetica",cex.axis=0.7, pty="m")
...
par(mar=c(2,5,0.5,0.8),mgp=c(1.8,0.2,0))
