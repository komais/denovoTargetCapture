...
bio1_YO0<-raster("yo_h_bio_1.asc", crs=projAlbers)
bio12_YO0<-raster("yo_h_bio_12.asc", crs=projAlbers)
bio1_YO1<-raster("yo_c_bio_1.asc", crs=projAlbers)
bio12_YO1<-raster("yo_c_bio_12.asc", crs=projAlbers)
...
bio5_YO0<-raster("yo_h_bio_5.asc", crs=projAlbers)
bio6_YO0<-raster("yo_h_bio_6.asc", crs=projAlbers)
bio5_YO1<-raster("yo_c_bio_5.asc", crs=projAlbers)
bio6_YO1<-raster("yo_c_bio_6.asc", crs=projAlbers)
