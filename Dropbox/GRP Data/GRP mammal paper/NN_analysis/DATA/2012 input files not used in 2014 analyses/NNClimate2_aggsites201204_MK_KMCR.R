...
setwd("/Users/mvsciences/Dropbox/GRP Data/GRP mammal paper/NN_analysis/DATA")
...
#new clippings to match resolution of other regions
bio1_YO0<-raster("yo_h_bio01Apr2014.asc", proj4string=projAlbers)
bio12_YO0<-raster("yo_h_bio12Apr2014.asc", proj4string=projAlbers)
bio1_YO1<-raster("yo_c_bio01Apr2014.asc", proj4string=projAlbers)
bio12_YO1<-raster("yo_c_bio12Apr2014.asc", proj4string=projAlbers)
...
bio5_YO0<-raster("yo_h_bio05Apr2014.asc", proj4string=projAlbers)
bio6_YO0<-raster("yo_h_bio06Apr2014.asc", proj4string=projAlbers)
bio5_YO1<-raster("yo_c_bio05Apr2014.asc", proj4string=projAlbers)
bio6_YO1<-raster("yo_c_bio06Apr2014.asc", proj4string=projAlbers)
...
write.table(neighbor_export,"new_nn_elv_2014_03_31_CONFIRM.csv", sep=",", row.names=F);
...
###########KMCR - RAN CODE TO HERE 31 MAR 2014#############
